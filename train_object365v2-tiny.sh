...
python train.py --weights ${model}.pt --cfg models/${model}.yaml --data data/Objects365-tiny.yaml --hyp data/hyps/hyp.scratch-low.yaml --epochs 3 --batch-size 8 --device 0 --workers 4 --name ${model}-tiny --exist-ok --noplots --cache ram
