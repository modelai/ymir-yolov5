...
- 基于最新版本的yolov5 v7.0+开发，支持目标检测

- 支持ymir2.1.0上的训练、推理及挖掘功能
...
- [modelai/ymir-yolov5](https://github.com/modelai/ymir-yolov5)

## 镜像地址

```
youdaoyzbx/ymir-executor:ymir2.1.0-yolov5-v7.0-cu111-tmi
```
...
| activate | 'SiLU' | 字符串 | 激活函数，默认为nn.Hardswish(), 参考 [pytorch激活函数](https://pytorch.org/docs/stable/nn.html#non-linear-activations-weighted-sum-nonlinearity) | 可选值: ELU, Hardswish, LeakyReLU, PReLU, ReLU, ReLU6, SiLU, ... |
